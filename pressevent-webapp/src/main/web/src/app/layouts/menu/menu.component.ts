...
export class AppMenuComponent implements OnInit {
    ...
    ngOnInit() {
		this.model = [
			{label: 'Dashboard', icon: 'fa fa-fw fa-home', routerLink: ['/home']},
			{label: 'Gestion Evenement', icon: 'fa fa-fw fa-calendar-o', routerLink: ['/event']},
            {label: 'Gestion utilisateur', icon: 'fa fa-fw fa-user', routerLink: ['/user']}            
        ];
    }
